              ...
              <div className="liner">
                ...
                <div className="layout-row">
                  <dl>
                    ...
                    <span className="action-flip" href="#" onClick={this.clickFlip}>More about this job <span className="icon-refresh"></span></span>
                </div>
              </div>
              <footer>
            ...
            <div className="card back">
              <div className="liner">
                ...
                <div className="layout-row divider">
                  ...
                  <span className="action-flip" href="#" onClick={this.clickFlip}>
